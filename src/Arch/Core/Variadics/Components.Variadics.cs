...
public ref struct Components<T0>
{
    ...
    public Components(ref T0 component__T0)
    {
#if NETSTANDARD2_1 || NET6_0
        // [Variadic: CopyLines]
        Component__T0 = new Ref<T0>(ref component__T0);
#else
        // [Variadic: CopyLines]
        Component__T0 = ref component__T0;
#endif
    }
}
...
public ref struct EntityComponents<T0>
{
    ...
    [SkipLocalsInit]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public EntityComponents(ref Entity entity, ref T0 component__T0)
    {
#if NETSTANDARD2_1 || NET6_0
